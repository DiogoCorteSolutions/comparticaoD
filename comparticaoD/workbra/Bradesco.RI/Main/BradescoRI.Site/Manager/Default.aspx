<%@ Register Src="~/Modulos/CMS/Modulos/ModEventos/ProxEventos.ascx" TagPrefix="ucProxEventos25" TagName="ProxEventos" %>
...
<div id="ctl10_CTT_459_ctl00_divConteudo">
    <div id="ctl10_CTT_459_ctl00_pnlNoticiaHome">
        ...
        <div class="row">
            <div class="col-lg-12 col-lg-offset-0 col-md-12 col-md-offset-0" style="margin-top: 10px;">
                ...
                <div id="ctl10_CTT_459_ctl00_divEsquerdoHome" class="col-md-6 noticias-1" style="background-image:url(&#39;/Uploads/Arquivos/1/deab8f73-1664-44cb-afd6-6721031487b3.png&#39;)">
                    <div class="btn btn-danger">em alta</div>
                    <p class="noti-subt">
                        <span id="ctl10_CTT_459_ctl00_lblSubTipoEsquerdo">Simuladores</span></p>
                    <h3 class="noti-tit">
                        <span id="ctl10_CTT_459_ctl00_lblTituloEsquerdo">Um investimento para chamar de seu</span></h3>
                    <p class="noti-parag"><span id="ctl10_CTT_459_ctl00_lblResumoEsquerdo"><p>Fa&ccedil;a uma simula&ccedil;&atilde;o de investimento com o Simulador Bradesco e saiba que tipo de investimento cabe no seu bolso.</p></span></p>
                </div>
                <div id="ctl10_CTT_459_ctl00_divDireitaSuperiorHome" class="col-md-6 noticias-2" style="background-image:url(&#39;/Uploads/Arquivos/1/db178285-b68b-4b54-bf41-3822b58296b6.jpg&#39;)">
                    <p class="noti-subt">
                        <span id="ctl10_CTT_459_ctl00_lblSubTipoDireitoSuperior">Simuladores</span></p>
                    <h4 class="noti-tit">
                        <span id="ctl10_CTT_459_ctl00_lblTituloDireitoSuperior">Noticia PODCAST</span></h4>
                    
                </div>
                <div id="ctl10_CTT_459_ctl00_divDireitaCentralHome" class="col-md-6 noticias-3" style="background-image:url(&#39;/Uploads/Arquivos/1/2f3bd30a-f5e0-4f5f-b081-68df54f99947.jpg&#39;)">
                    <p class="noti-subt">
                        <span id="ctl10_CTT_459_ctl00_lblSubTipoDireitoCentral">Simuladores</span></p>
                    <h4 class="noti-tit">
                        <span id="ctl10_CTT_459_ctl00_lblTituloDireitoCentral">Notícia Gustavo</span></h4>
                    
                </div>
                <div id="ctl10_CTT_459_ctl00_divDireitaInferiorHome" class="col-md-6 noticias-4" style="background-image:url(&#39;/Uploads/Arquivos/1/deab8f73-1664-44cb-afd6-6721031487b3.png&#39;)">
                    <h4 class="noti-tit">
                        <span id="ctl10_CTT_459_ctl00_lblSubTipoDireitoInferior">Simuladores</span></h4>
                    <p class="noti-subt">
                        <span id="ctl10_CTT_459_ctl00_lblTituloDireitoInferior">Um investimento para chamar de seu</span>
                    </p>
                    <span id="ctl10_CTT_459_ctl00_lblResumoDireitoInferior"><p>Fa&ccedil;a uma simula&ccedil;&atilde;o de investimento com o Simulador Bradesco e saiba que tipo de investimento cabe no seu bolso.</p></span>
                </div>
            </div>
...
<ucProxEventos25:ProxEventos runat ="server" ID="ProxEventos461" IdConteudo="461" />
            </div>
        </div>
