...
public class DOModEvento
{
    ...
    public static Evento Obter(int pintId, int pintIdioma = 0)
    {
        string strConectionString = ConfigurationManager.ConnectionStrings["BradescoRI"].ConnectionString;
        SqlConnection objConexao = new SqlConnection(strConectionString);
        ...
        if(pintIdioma != 0) objComando.Parameters.Add("@idiomaId", SqlDbType.Int).Value = pintIdioma;
    ...
    public static int InserirTipo(TipoEvento pobjTipoEvento)
    {
        string strConectionString = ConfigurationManager.ConnectionStrings["BradescoRI"].ConnectionString;
        SqlConnection objConexao = new SqlConnection(strConectionString);

        SqlCommand objComando = new SqlCommand("SPE_I_TIPO_EVENTO");
        objComando.Connection = objConexao;
        objComando.CommandType = CommandType.StoredProcedure;
    ...
    public static List<ProxEventos> ListarProxEventos(int pintIdIdioma, int pintIdTipoEvento = 0)
    {
        string strConectionString = ConfigurationManager.ConnectionStrings["BradescoRI"].ConnectionString;
        SqlConnection objConexao = new SqlConnection(strConectionString);
    ...
    public static List<string> ListarAnoEvento()
    {
        string strConectionString = ConfigurationManager.ConnectionStrings["BradescoRI"].ConnectionString;
        SqlConnection objConexao = new SqlConnection(strConectionString);

        SqlCommand objComando = new SqlCommand("SPE_L_ANO_EVENTO");
        objComando.Connection = objConexao;
        objComando.CommandType = CommandType.StoredProcedure;
    ...
    public static List<string> ListarAnoPeriodo()
    {
        string strConectionString = ConfigurationManager.ConnectionStrings["BradescoRI"].ConnectionString;
        SqlConnection objConexao = new SqlConnection(strConectionString);

        SqlCommand objComando = new SqlCommand("SPE_L_ANO_PERIODO_SILENCIO");
        objComando.Connection = objConexao;
        objComando.CommandType = CommandType.StoredProcedure;
    ...
    public static List<PeriodoSilencio> ListarPeriodoSilencio(int pintAno = 0)
    {
        ...
        ///Parametros
        if(pintAno > 0) objComando.Parameters.Add("@ano", SqlDbType.Int).Value = pintAno;
    ...
    public static void ExcluirTipo(int pintId)
    {
        string strConectionString = ConfigurationManager.ConnectionStrings["BradescoRI"].ConnectionString;
        SqlConnection objConexao = new SqlConnection(strConectionString);

        SqlCommand objComando = new SqlCommand("SPE_D_TIPO_EVENTO");
        objComando.Connection = objConexao;
        objComando.CommandType = CommandType.StoredProcedure;
    ...
    public static void ExcluirPeriodoSilencio(int pintId)
    {
        string strConectionString = ConfigurationManager.ConnectionStrings["BradescoRI"].ConnectionString;
        SqlConnection objConexao = new SqlConnection(strConectionString);

        SqlCommand objComando = new SqlCommand("SPE_D_PERIODO_SILENCIO");
        objComando.Connection = objConexao;
        objComando.CommandType = CommandType.StoredProcedure;

        //Define parametros da procedure               
        objComando.Parameters.Add("@periodoId", SqlDbType.Int).Value = pintId;
