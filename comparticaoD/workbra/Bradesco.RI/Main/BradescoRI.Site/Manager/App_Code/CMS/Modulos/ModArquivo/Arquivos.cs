...
public class Arquivos
{
    ...
    public virtual Boolean Capa { get; set; }
    public virtual int CapaId { get; set; }
    public virtual Boolean Listagem { get; set; }
    public virtual Boolean Detalhe { get; set; }
    ...
    public void FromIDataReader(IDataReader pobjIDataReader)
    {
        ...
        if ((!object.ReferenceEquals(pobjIDataReader["Capa"], DBNull.Value)))
            this.Capa = Convert.ToBoolean(pobjIDataReader["Capa"].ToString());
        ...
        if ((!object.ReferenceEquals(pobjIDataReader["Detalhe"], DBNull.Value)))
            this.Detalhe = Convert.ToBoolean(pobjIDataReader["Detalhe"].ToString());
    }
    #endregion
}