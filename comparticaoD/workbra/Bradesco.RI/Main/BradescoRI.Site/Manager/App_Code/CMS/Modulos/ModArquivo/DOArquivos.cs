...
public class DOArquivos
{
    ...
    #region Listar Capas
    public static List<Arquivos> ListarCapas()
    {
        string strConectionString = ConfigurationManager.ConnectionStrings["BradescoRI"].ConnectionString;
        SqlConnection objConexao = new SqlConnection(strConectionString);
        ...
        objComando.Parameters.Add("@Capa", SqlDbType.Bit).Value = true;
    ...
    #region Listar Listagem
    public static List<Arquivos> ListarImagensListagem()
    {
        string strConectionString = ConfigurationManager.ConnectionStrings["BradescoRI"].ConnectionString;
        SqlConnection objConexao = new SqlConnection(strConectionString);
        ...
        objComando.Parameters.Add("@Listagem", SqlDbType.Bit).Value = true;
    ...
    #region  Listar Detalhes
    public static List<Arquivos> ListarImagensDetalhes()
    {
        string strConectionString = ConfigurationManager.ConnectionStrings["BradescoRI"].ConnectionString;
        SqlConnection objConexao = new SqlConnection(strConectionString);
        ...
        objComando.Parameters.Add("@Detalhe", SqlDbType.Bit).Value = true;
    ...
    public static int Inserir(Arquivos pObjArquivos)
    {
        ...
        objComando.Parameters.Add("@StatusId", SqlDbType.Int).Value = pObjArquivos.StatusId;
        objComando.Parameters.Add("@Capa", SqlDbType.Bit).Value = pObjArquivos.Capa;
        objComando.Parameters.Add("@ArquivoId", SqlDbType.Int).Direction = ParameterDirection.Output;
        ...
        try
        {
            ...
            pObjArquivos.Id = int.Parse(objComando.Parameters["@ArquivoId"].Value.ToString());

            return pObjArquivos.Id;
        }
        catch (Exception ex)
        {
            throw ex;
