...
public class DONoticia
{
    ...
    public static Noticia Inserir(Noticia pobjNoticia)
    {
        ...
        objComando.Parameters.Add("@SubTipoNoticiaId", SqlDbType.Int).Value = pobjNoticia.TipoNoticia.ID;
        //objComando.Parameters.Add("@ArquivoDetalheId", SqlDbType.Int).Value = pobjNoticia.Detalhe.Id;
        //objComando.Parameters.Add("@ArquivoListagemId", SqlDbType.Int).Value = pobjNoticia.Listagem.Id;
