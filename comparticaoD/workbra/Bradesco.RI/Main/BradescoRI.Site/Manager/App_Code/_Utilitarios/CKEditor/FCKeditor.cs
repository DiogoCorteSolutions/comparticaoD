...
namespace Controles.FCKeditor
{
	...
	public class FCKeditor : System.Web.UI.Control, IPostBackDataHandler
	{
		...
		/// <summary>
		/// <p>
        ///		Seta ou busca o caminho virtual para a pasta do editor. É relativo a página corrente.
		/// </p>
		/// <p>
		///		O valor padrão é "/fckeditor/".
		/// </p>
		/// <p>
        ///		O caminho base pode ser configurado no Web.config usando a sessão appSettings[FCKeditor:BasePath]
		///		Por exemplo:
		///		<code>
		///		&lt;configuration&gt;
		///			&lt;appSettings&gt;
		...
		protected override void OnPreRender( EventArgs e )
		{
            ...
            // Busca pelo "ScriptManager control" da página.
			Control oParent = this.Parent;
			while ( oParent != null )
			{
				foreach ( object control in oParent.Controls )
				{
                    // Corresponder por tipo de nome.
            ...
            // Se o ScriptManager controle está disponível.
			if ( oScriptManager != null )
			{
				try
				{
		...
		/// <summary>
		/// Verifica se a requisição HTTP vem de um browser compatível com FCKeditor.
		/// </summary>
		/// <returns>"true" se o browser é compatível.</returns>
        ...
        public static bool IsCompatibleBrowser(System.Web.HttpRequest request)
		{
			...
			// Internet Explorer 5.5+ para Windows
