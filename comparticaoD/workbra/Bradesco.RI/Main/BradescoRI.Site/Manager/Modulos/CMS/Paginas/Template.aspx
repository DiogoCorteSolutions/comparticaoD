...
<body>
    ...
    <form id="form1" runat="server">
        ...
        <!-- Main Content -->
        <div class="container container-modulos">
            <div class="row">
            <div class="side-menu" id="sideMenu">
                <menu>
                    <ul class="nav nav-tabs nav-stacked top-modulos-config">
                        <li><a href="#myModal" data-backdrop="false" data-toggle="modal">Configurações</a></li>
                        <li>
                            <asp:Button ID="btnPreview" runat="server" OnClick="btnPreview_Click" alt="Visualizar página" title="Visualizar página" CausesValidation="false" />
                        </li>
                    </ul>
                </menu>
            </div>
            <div id="myModal" class="modal fade">
                <div class="modal-dialog modal-configuracoes">
                    <div class="modal-content">
                        ...
                        <div class="modal-body panel-body">
                            <div class="row menu-configuracoes">
                                ...
                                <div id="divConfiguracoes" class="menu-modulos-config" runat="server">
                                    ...
                                    <div class="col-lg-12 col-lg-offset-0 col-md-12 col-md-offset-0">
                                        <div class="col-md-2">
                                            <asp:Label ID="lblMetaTags" runat="server" alt="MetaTags página" title="MetaTags página" Font-Bold="true"></asp:Label>
                                        </div>
                                        <div class="col-md-12">
                                    ...
                                    <div id="template" class="col-lg-12 col-lg-offset-0 col-md-12 col-md-offset-0">
                                        <div class="col-md-6">
                                    ...
                                    <div id="divModulos" class="col-lg-12 col-lg-offset-0 col-md-12 col-md-offset-0" runat="server">
                                        <div class="col-md-12">
