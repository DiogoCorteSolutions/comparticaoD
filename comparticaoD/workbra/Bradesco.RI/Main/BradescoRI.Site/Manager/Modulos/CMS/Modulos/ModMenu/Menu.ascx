    ...
    $(document).ready(function () {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                var linkR = $('<a id="relInvest" href="' + linkRelacoesInvestidores.Url + '" target="' + linkRelacoesInvestidores.Target + '" class="dropdown-toggle link-sup bot-relin ' + document.getElementById('<%=hdnCorMenu.ClientID%>').value + '">' + linkRelacoesInvestidores.Nome + '</a>');
