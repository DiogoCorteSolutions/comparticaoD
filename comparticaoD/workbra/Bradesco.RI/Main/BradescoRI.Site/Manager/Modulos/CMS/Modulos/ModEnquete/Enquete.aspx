<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Enquete.aspx.cs" Inherits="Modulos_CMS_Modulos_ModEnquete_Enquete" %>
...
<body class="modulos-cms">
    <div id="wrapper">
         <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Enquete</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                                ...
                                <div class="col-lg-6">
                                    <form id="form1" runat="server" role="form">
                                        <div class="form-group">
                                            <label>Enquete:</label>
                                                <asp:DropDownList ID="ddlEnquete" runat="server" AutoPostBack="true" CssClass="form-control"></asp:DropDownList>
                                        </div>
                                        <div class="form-group">
                                            <label>Título</label>
                                            <asp:TextBox ID="txtTitulo" runat="server" MaxLength="100" class="form-control">></asp:TextBox>
                                        </div>
                                        <div class="form-group">
                                            <label>URL Fale Conosco</label>
                                            <asp:TextBox ID="txtUrl" CssClass="txtUrl" runat="server" MaxLength="1000" class="form-control"></asp:TextBox>
                                        </div>
                                        <div class="form-group">
