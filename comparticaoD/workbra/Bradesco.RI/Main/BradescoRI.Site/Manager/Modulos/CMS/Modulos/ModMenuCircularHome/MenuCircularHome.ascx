<%@ Control Language="C#" AutoEventWireup="true" CodeFile="MenuCircularHome.ascx.cs" Inherits="Modulos_CMS_Modulos_ModMenuCircularHome_MenuCircularHome" %>

<div id="divSemConteudo" runat="server" class="moduloSemConteudo">
    <asp:Label ID="lblTitulo" runat="server"><%= string.Format(Resources.Textos.Modulo_Sem_Conteudo, "Menu Circular - Home") %></asp:Label>
</div>

<div id="divConteudo" runat="server">

    <asp:Repeater runat="server" ID="rptMenuCircular" OnItemDataBound="rptMenuCircularHome_ItemDataBound">
        <HeaderTemplate>
