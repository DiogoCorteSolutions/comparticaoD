<%@ Control Language="C#" AutoEventWireup="true" CodeFile="template8Abas.ascx.cs" Inherits="Modulos_CMS_Paginas_Templates_template8Abas" %>
...
<div class="row">
    <div class="col-lg-12 col-md-12">
        ...
        <ul class="nav nav-tabs mod-abas" role="tablist">
            ...
            <li role="presentation"><a href="#Aba8" aria-controls="Aba8" role="tab" data-toggle="tab" runat="server" id="controle8"></a></li>
        </ul>
        ...
        <div class="col-lg-12 col-md-12 tab-content">
            ...
            <div role="tabpanel" class="tab-pane fade" id="Aba8">
                <asp:PlaceHolder ID="placeHolder_8" runat="server"></asp:PlaceHolder>
            </div>
        </div>
