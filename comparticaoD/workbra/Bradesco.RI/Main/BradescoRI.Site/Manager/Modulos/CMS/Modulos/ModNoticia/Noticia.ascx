...
<div id="divConteudo" runat="server">
    <asp:Panel ID="pnlNoticiaHome" runat="server" Visible="false">
        <div class="row">
            <div class="col-lg-12 col-lg-offset-0 col-md-12 col-md-offset-0" style="margin-top: 10px;">
                ...
                <div id="divEsquerdoHome" runat="server" class="col-md-6 noticias-1">
                    <div class="btn btn-danger">em alta</div>
                    <p class="noti-subt">
                        <asp:Label ID="lblSubTipoEsquerdo" runat="server"></asp:Label>
                    </p>
                    <h3 class="noti-tit">
                        <asp:Label ID="lblTituloEsquerdo" runat="server"></asp:Label></h3>
                    <p class="noti-parag">
                        <asp:Label ID="lblResumoEsquerdo" runat="server"></asp:Label></p>
                </div>
                <div id="divDireitaSuperiorHome" runat="server" class="col-md-6 noticias-2">
                    <p class="noti-subt">
                        <asp:Label ID="lblSubTipoDireitoSuperior" runat="server"></asp:Label>
                    </p>
                    <h4 class="noti-tit">
                ...
                <div id="divDireitaCentralHome" runat="server" class="col-md-6 noticias-3">
                    <p class="noti-subt">
                        <asp:Label ID="lblSubTipoDireitoCentral" runat="server"></asp:Label>
                    </p>
                    <h4 class="noti-tit">
                ...
                <div id="divDireitaInferiorHome" runat="server" class="col-md-6 noticias-4">
                    <h4 class="noti-tit">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 col-lg-offset-0 col-md-12 col-md-offset-0 not-sub-tot">
                    ...
                    <hr class="small2">
                    <div id="divEsquerdoDestaque" runat="server" class="col-md-6 noticias-1" onclick="funcao_aqui();">
                        <div class="btn btn-danger">em alta</div>
                        <p class="noti-subt">
                            <asp:Label ID="lblSubTipoEsquerdaDestaque" runat="server"></asp:Label></p>
                        <h3 class="noti-tit">
                            <asp:Label ID="lblTituloEsquerdaDestaque" runat="server"></asp:Label></h3>
                        <p class="noti-parag">
                            <asp:Label ID="lblResumoEsquerdaDestaque" runat="server"></asp:Label></p>
                    </div>
                    <div id="divDireitaSuperiorDestaque" runat="server" class="col-md-6 not-sub-2" onclick="funcao_aqui();">
                        <p class="noti-subt">
                            <asp:Label ID="lblSubTipoDireitaSuperiorDestaque" runat="server"></asp:Label>
                        </p>
                        <h4 class="noti-tit">
                            <asp:Label ID="lblTituloDireitaSuperiorDestaque" runat="server"></asp:Label></h4>
                    </div>
                    <div id="divDireitaInferiorDestaque" runat="server" class="col-md-6 not-sub-3" onclick="funcao_aqui();">
                        <p class="noti-subt">
                            <asp:Label ID="lblSubTipoDireitaInferiorDestaque" runat="server"></asp:Label></p>
                        <h4 class="noti-tit">
                            <asp:Label ID="lblTituloDireitaInferiorDestaque" runat="server"></asp:Label></h4>
                    </div>
                </div>
            </div>
        </div>
    ...
    <asp:Panel ID="pnlNoticiaInterna" runat="server" Visible="false">
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="not-alta" id="divBackGround" runat="server">
                    <div class="btn btn-danger">em alta</div>
                    <p class="noti-subt">
                        <asp:Label ID="lblSubTipoDestaqueInterna" runat="server"></asp:Label></p>
                    <h3 class="noti-tit">
                        <asp:Label ID="lblTituloDestaqueInterna" runat="server"></asp:Label></h3>
                    <asp:Label ID="lblResumoDestaqueInterna" runat="server"></asp:Label>
                ...
                <ItemTemplate>
                    <div class="mod-not">
                            ...
                            <div class="media-left mod-not-img">
                                <asp:Image ID="imgNoticia" CssClass="not-img" runat="server" />
                            ...
                            <div class="media-body mod-not-content">
                                ...
                                <div class="not-lnk"><span class="glyphicon glyphicon-play-circle"></span><span class="not-lnk-txt">VER NOTÍCIA</span></div>
                            </div>
                    </div>
                </ItemTemplate>
