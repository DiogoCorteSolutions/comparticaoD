<%@ Page Language="C#" MasterPageFile="~/Modulos/Modulos.master"  AutoEventWireup="true" CodeFile="ListarLinks.aspx.cs" Inherits="Modulos_Links_ListarLinks" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="contentInterna" runat="Server">
    ...
    <asp:DataGrid summary="Lista de Links" ID="grdDados" runat="server" AutoGenerateColumns="false" CssClass="listagem-Grid" AlternatingRowStyle-CssClass="par" Width="100%" AllowPaging="True"
        ...
        <Columns>
            ...
            <asp:BoundColumn Visible="false" DataField="IdLink" HeaderText="IdLink" SortExpression="IdLink" HeaderStyle-CssClass="tabelaHeader" />
            ...
            <asp:BoundColumn DataField="Titulo" SortExpression="Titulo" HeaderText="Titulo" HeaderStyle-CssClass="tabelaHeader asc"/>            
            ...
            <asp:TemplateColumn HeaderText="Editar" HeaderStyle-CssClass="tabelaHeader" ItemStyle-Width="5%" ItemStyle-HorizontalAlign="Center">
                <ItemTemplate>
                    <a id="A1" title="Editar" runat="server" href='<%# String.Format("EditarLinks.aspx?Id={0}&Grupo={1}&Idioma={2}", Eval("IdLink"), Eval("IdGrupo"), Eval("IdIdioma"))%>'>
