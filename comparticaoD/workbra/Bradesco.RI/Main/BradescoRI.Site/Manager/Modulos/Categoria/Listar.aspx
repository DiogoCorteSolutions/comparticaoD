<%@ Page Language="C#" MasterPageFile="~/Modulos/Modulos.master" AutoEventWireup="true" CodeFile="Listar.aspx.cs" Inherits="Modulos_CMS_Paginas_ListarArea" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="contentInterna" runat="Server">
    ...
    <asp:DataGrid summary="Lista de Eventos" ID="grdDados" runat="server" AutoGenerateColumns="false" CssClass="listagem-Grid" AlternatingRowStyle-CssClass="par" Width="100%" AllowPaging="True"
        ...
        <Columns>
            ...
            <asp:BoundColumn Visible="false" DataField="IdCategoria" HeaderText="ID" SortExpression="IdCategoria" HeaderStyle-CssClass="tabelaHeader" />
            <asp:BoundColumn DataField="Descricao" SortExpression="Descricao" HeaderText="Área" HeaderStyle-CssClass="tabelaHeader asc" />
            ...
            <asp:TemplateColumn HeaderText="Editar" HeaderStyle-CssClass="tabelaHeader" ItemStyle-Width="5%" ItemStyle-HorizontalAlign="Center">
                <ItemTemplate>
                    <a id="A1" title="Editar" runat="server" href='<%# String.Format("Editar.aspx?Id={0}", Eval("IdCategoria"))%>'>
