<%@ Page Title="" Language="C#" MasterPageFile="~/Modulos/Modulos.master" AutoEventWireup="true" CodeFile="ListarNoticias.aspx.cs" Inherits="Modulos_Noticias_ListarNoticias" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="contentInterna" runat="Server">
    ...
    <asp:GridView summary="Lista de Notícias" ID="grdDados" runat="server" AutoGenerateColumns="false" CssClass="listagem-Grid" AlternatingRowStyle-CssClass="par" Width="100%" AllowPaging="True"
        ...
        <Columns>
            ...
            <asp:BoundField DataField="Titulo" SortExpression="Titulo" HeaderText="Título" HeaderStyle-CssClass="tabelaHeader asc" />
            <asp:TemplateField HeaderText="Ações" HeaderStyle-CssClass="tabelaHeader" ItemStyle-Width="5%" ItemStyle-HorizontalAlign="Center">
                <ItemTemplate>

                    <a id="A1" title="Notícia" runat="server" href='<%# String.Format("EditarNoticia.aspx?Noticia={0}", Eval("Id"))%>'>
