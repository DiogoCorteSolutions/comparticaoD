<%@ Page MasterPageFile="~/Modulos/Modulos.master"  Language="C#" AutoEventWireup="true" CodeFile="ListarMenuCircular.aspx.cs" Inherits="Modulos_MenuCircular_ListarMenuCircular" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="contentInterna" runat="Server">
    ...
    <div class="filtros">
        ...
        <div class="fields-edit">
            <label>
                <span>
                    <asp:Label ID="lblDescricao" runat="server" title="Grupo"><%=Resources.MenuCircular.Grupo %></asp:Label>
                </span>
    ...
    <asp:DataGrid summary="Lista de Menus" ID="grdDados" runat="server" AutoGenerateColumns="false" CssClass="listagem-Grid" AlternatingRowStyle-CssClass="par" Width="100%" AllowPaging="True"
        ...
        <Columns>
            ...
            <asp:BoundColumn Visible="false" DataField="IdMenuCircular" HeaderText="IdMenuCircular" SortExpression="IdMenuCircular" HeaderStyle-CssClass="tabelaHeader" />
            ...
            <asp:BoundColumn DataField="Titulo" SortExpression="Titulo" HeaderText="Titulo" HeaderStyle-CssClass="tabelaHeader asc" ItemStyle-Width="20%" />
            <asp:BoundColumn DataField="Arquivo" SortExpression="Arquivo" HeaderText="Arquivo" HeaderStyle-CssClass="tabelaHeader" ItemStyle-Width="30%" />
            <asp:BoundColumn DataField="URL" SortExpression="URL" HeaderText="URL" HeaderStyle-CssClass="tabelaHeader" ItemStyle-Width="40%" />
            <asp:TemplateColumn HeaderText="Editar" HeaderStyle-CssClass="tabelaHeader" ItemStyle-Width="5%" ItemStyle-HorizontalAlign="Center">
                <ItemTemplate>
                    <a id="A1" title="Editar" runat="server" href='<%# String.Format("EditarMenuCircular.aspx?Id={0}&Grupo={1}&Idioma={2}", Eval("IdMenuCircular"), Eval("IdGrupo"), Eval("IdIdioma"))%>'>
