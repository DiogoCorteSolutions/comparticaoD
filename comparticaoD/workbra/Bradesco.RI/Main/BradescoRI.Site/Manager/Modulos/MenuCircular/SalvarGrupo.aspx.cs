...
public partial class Modulos_MenuCircular_Editar : System.Web.UI.Page
{
    ...
    #region Variáveis
    private int codigo;
    private GrupoMenuCircular gobjGrupoMenuCircular;
    #endregion
    ...
    private void CarregarObjetos(Utilitarios.TipoTransacao objTipoTransacao)
    {
        switch (objTipoTransacao)
        {
            ...
            case Utilitarios.TipoTransacao.Salvar:
                ...
                if (gobjGrupoMenuCircular == null)
                {
                    gobjGrupoMenuCircular = new GrupoMenuCircular();
                }

                gobjGrupoMenuCircular.Descricao = txtGrupo.Text;
