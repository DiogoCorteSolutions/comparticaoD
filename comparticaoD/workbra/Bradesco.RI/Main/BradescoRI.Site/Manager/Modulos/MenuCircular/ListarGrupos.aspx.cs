...
public partial class Modulos_MenuCircular_Listar : System.Web.UI.Page
{
    ...
    {
        if (listPager.DataSource != null && listPager.DataSource is IEnumerable<GrupoMenuCircular>)
        {
            IEnumerable<GrupoMenuCircular> dados = (IEnumerable<GrupoMenuCircular>)listPager.DataSource;
