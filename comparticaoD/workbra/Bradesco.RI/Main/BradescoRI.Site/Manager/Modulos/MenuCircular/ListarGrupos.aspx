<%@ Page Language="C#" MasterPageFile="~/Modulos/Modulos.master" AutoEventWireup="true" CodeFile="ListarGrupos.aspx.cs" Inherits="Modulos_MenuCircular_Listar" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="contentInterna" runat="Server">
    ...
    <asp:DataGrid summary="Lista de Grupos" ID="grdDados" runat="server" AutoGenerateColumns="false" CssClass="listagem-Grid" AlternatingRowStyle-CssClass="par" Width="100%" AllowPaging="True"
        ...
        <Columns>
            ...
            <asp:TemplateColumn HeaderText="Adicionar Menu Circular" HeaderStyle-CssClass="tabelaHeader" ItemStyle-Width="5%" ItemStyle-HorizontalAlign="Center">
                <ItemTemplate>
                    <a id="A1" title="Menu Circular" runat="server" href='<%# String.Format("ListarMenuCircular.aspx?Grupo={0}", Eval("IdGrupo"))%>'>
