<%@ Page Language="C#" MasterPageFile="~/Modulos/Modulos.master" AutoEventWireup="true" CodeFile="Listar.aspx.cs" Inherits="Modulos_PeriodoSilencio_Listar" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="contentInterna" runat="Server">
    ...
    <asp:DataGrid summary="Lista" ID="grdDados" runat="server" AutoGenerateColumns="false" CssClass="listagem-Grid" AlternatingRowStyle-CssClass="par" Width="100%" AllowPaging="True"
        PageSize="50" >
        <Columns>
            ...
            <asp:BoundColumn Visible="false" DataField="IdPeriodo" HeaderText="IdPeriodo"  HeaderStyle-CssClass="tabelaHeader" />
            <asp:BoundColumn DataField="DataDivulgacao" HeaderText="Data Divulgação" DataFormatString="{0:d}" HeaderStyle-CssClass="tabelaHeader" />
            <asp:BoundColumn DataField="DataInicio" HeaderText="Data Início" DataFormatString="{0:d}" HeaderStyle-CssClass="tabelaHeader" />
            <asp:BoundColumn DataField="DataFim" HeaderText="Data Fim" DataFormatString="{0:d}" HeaderStyle-CssClass="tabelaHeader" />                       
        </Columns>
