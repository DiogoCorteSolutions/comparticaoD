<%@ Page Title="" Language="C#" MasterPageFile="~/Modulos/Modulos.master" AutoEventWireup="true" CodeFile="ListarRelatorios.aspx.cs" Inherits="Modulos_Relatorios_ListarRelatorios" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="contentInterna" runat="Server">
    <div id="title">
        <h1>
            ...
            <asp:HiddenField ID="hdnRelatorioId" runat="server" />
        </h1>
    </div>
    <br />
    <div class="filtros">
        ...
        <div class="fields-edit">
            <label>
                ...
                <asp:DropDownList ID="ddlTipoRelatio" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddlTipoRelatio_SelectedIndexChanged" alt="Selecione o tipo de relatório" title="Selecion o tipo de relatório"></asp:DropDownList>
            </label>
    ...
    <asp:GridView summary="Lista de Relatórios" ID="grdDados" runat="server" AutoGenerateColumns="false" CssClass="listagem-Grid" AlternatingRowStyle-CssClass="par" Width="100%" AllowPaging="True"
        PageSize="50" AllowSorting="True" OnRowDataBound="grdDados_RowDataBound1" OnSelectedIndexChanged="grdDados_SelectedIndexChanged">
        <Columns>
            ...
            <asp:TemplateField SortExpression="TipoRelatorio" HeaderText="Tipo de Relatório" HeaderStyle-CssClass="tabelaHeader" ItemStyle-Width="40%" ItemStyle-HorizontalAlign="Left">
                <ItemTemplate>
            ...
            <asp:TemplateField HeaderText="Ações" HeaderStyle-CssClass="tabelaHeader" ItemStyle-Width="5%" ItemStyle-HorizontalAlign="Center">
                <ItemTemplate>
                    <a id="A1" title="Notícia" runat="server" href='<%# String.Format("EditarRelatorios.aspx?Relatorio={0}", Eval("Id"))%>'>
