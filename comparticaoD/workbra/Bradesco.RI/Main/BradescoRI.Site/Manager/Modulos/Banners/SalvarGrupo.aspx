<%@ Page Language="C#" MasterPageFile="~/Modulos/Modulos.master" AutoEventWireup="true" CodeFile="SalvarGrupo.aspx.cs" Inherits="Modulos_Banner_SalvarGrupo" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="contentInterna" runat="Server">
    ...
    <div class="fields">
        <label>
            <span>
                <asp:Label ID="lblGrupo" runat="server" AssociatedControlID="txtGrupo" title="Grupo"><%=Resources.Usuario.Nome %>*</asp:Label>
            </span>
