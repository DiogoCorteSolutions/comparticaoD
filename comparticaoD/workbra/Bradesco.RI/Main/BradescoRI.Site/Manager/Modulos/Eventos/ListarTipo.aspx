<%@ Page Language="C#" MasterPageFile="~/Modulos/Modulos.master"  AutoEventWireup="true" CodeFile="ListarTipo.aspx.cs" Inherits="Modulos_Eventos_ListarTipo" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="contentInterna" runat="Server">
    ...
    <asp:DataGrid summary="Lista de Tipos de Evento" ID="grdDados" runat="server" AutoGenerateColumns="false" CssClass="listagem-Grid" AlternatingRowStyle-CssClass="par" Width="100%" AllowPaging="True"
        PageSize="50">
        <Columns>
            ...
            <asp:BoundColumn Visible="false" DataField="IdTipoEvento" HeaderText="IdTipoEvento"  HeaderStyle-CssClass="tabelaHeader" />
            <asp:BoundColumn Visible="false" DataField="IdIdioma" HeaderText="IdIdioma"  HeaderStyle-CssClass="tabelaHeader" />
            <asp:BoundColumn DataField="Descricao" HeaderText="Descrição"  HeaderStyle-CssClass="tabelaHeader"/>
            <asp:BoundColumn DataField="Cor" HeaderText="Cor"  HeaderStyle-CssClass="tabelaHeader"/>
            ...
            <asp:TemplateColumn HeaderText="Editar" HeaderStyle-CssClass="tabelaHeader" ItemStyle-Width="5%" ItemStyle-HorizontalAlign="Center">
                <ItemTemplate>
                    <a id="A1" title="Editar" runat="server" href='<%# String.Format("EditarTipo.aspx?IdTipo={0}&IdIdioma={1}", Eval("IdTipoEvento"), Eval("IdIdioma"))%>'>
