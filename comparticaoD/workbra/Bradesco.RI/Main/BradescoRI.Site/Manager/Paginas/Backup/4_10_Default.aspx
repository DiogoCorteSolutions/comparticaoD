        ...
        <div class="row">
            <div class="col-lg-12 col-lg-offset-0 col-md-12 col-md-offset-0" style="margin-top: 10px;">
                ...
                <div class="col-md-6 noticias-1">
                    ...
                    <p class="noti-subt">
                        <span id="ctl10_CTT_459_ctl00_lblSubTipoEsquerdo"></span></p>
                    <h3 class="noti-tit">
                        <span id="ctl10_CTT_459_ctl00_lblTituloEsquerdo">Notícia Gustavo</span></h3>
                    <span id="ctl10_CTT_459_ctl00_lblResumoEsquerdo"><p>&nbsp;<strong style="margin: 0px; padding: 0px; font-family: &quot;Open Sans&quot;, Arial, sans-serif; font-size: 14px; text-align: justify;">Lorem Ipsum</strong><span style="font-family: &quot;Open Sans&quot;, Arial, sans-serif; font-size: 14px; text-align: justify;">&nbsp;is simply dummy text of the printing and typesetting industry.</span></p></span>
                    
                </div>
                <div class="col-md-6 noticias-2">
                    <p class="noti-subt">
                        <span id="ctl10_CTT_459_ctl00_lblSubTipoDireitoSuperior"></span></p>
                    <h4 class="noti-tit">
                        <span id="ctl10_CTT_459_ctl00_lblTituloDireitoSuperior"></span></h4>
                    <span id="ctl10_CTT_459_ctl00_lblResumoDireitoSuperior"></span>
                    
                </div>
                <div class="col-md-6 noticias-3">
                    <p class="noti-subt">
                        <span id="ctl10_CTT_459_ctl00_lblSubTipoDireitoCentral"></span></p>
                    <h4 class="noti-tit">
                        <span id="ctl10_CTT_459_ctl00_lblTituloDireitoCentral">Noticia PODCAST</span></h4>
                    <span id="ctl10_CTT_459_ctl00_lblResumoDireitoCentral"><p>&nbsp;Noticia de PODCAST</p></span>
                    
                </div>
                <div class="col-md-6 noticias-4">
                    <h4 class="noti-tit">
                        <span id="ctl10_CTT_459_ctl00_lblSubTipoDireitoInferior"></span></h4>
                    <p class="noti-subt">
                        <span id="ctl10_CTT_459_ctl00_lblTituloDireitoInferior"></span>
                    </p>
                    <span id="ctl10_CTT_459_ctl00_lblResumoDireitoInferior"></span>
