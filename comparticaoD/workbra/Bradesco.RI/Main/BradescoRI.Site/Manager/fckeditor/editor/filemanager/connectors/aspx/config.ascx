<%@ Control Language="C#" EnableViewState="false" AutoEventWireup="false" Inherits="Controles.FCKeditor.FileBrowser.Config" %>
<%--
...
<script runat="server">
    ...
    public override void SetConfig()
    {
        ...
        TypeConfig["File"].QuickUploadPath              = TypeConfig["File"].FilesPath;
        ...
        TypeConfig["Image"].QuickUploadPath             = TypeConfig["Image"].FilesPath;
        ...
        TypeConfig[ "Flash" ].QuickUploadPath           = TypeConfig[ "Flash" ].FilesPath;
        ...
        TypeConfig[ "Media" ].QuickUploadPath           = TypeConfig[ "Media" ].FilesPath;
