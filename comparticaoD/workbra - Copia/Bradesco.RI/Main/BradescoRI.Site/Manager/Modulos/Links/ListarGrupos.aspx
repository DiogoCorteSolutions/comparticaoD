<%@ Page Language="C#" MasterPageFile="~/Modulos/Modulos.master"  AutoEventWireup="true" CodeFile="ListarGrupos.aspx.cs" Inherits="Modulos_Links_ListarGrupos" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="contentInterna" runat="Server">
    ...
    <asp:DataGrid summary="Lista de Grupos" ID="grdDados" runat="server" AutoGenerateColumns="false" CssClass="listagem-Grid" AlternatingRowStyle-CssClass="par" Width="100%" AllowPaging="True"
        ...
        <Columns>
            ...
            <asp:TemplateColumn HeaderText="Adicionar Links" HeaderStyle-CssClass="tabelaHeader" ItemStyle-Width="5%" ItemStyle-HorizontalAlign="Center">
                <ItemTemplate>
                    <a id="A1" title="Links" runat="server" href='<%# String.Format("ListarLinks.aspx?Grupo={0}", Eval("IdGrupo"))%>'>
