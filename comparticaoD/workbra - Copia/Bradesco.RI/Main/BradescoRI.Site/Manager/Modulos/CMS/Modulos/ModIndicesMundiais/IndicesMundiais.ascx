<%@ Control Language="C#" AutoEventWireup="true" CodeFile="IndicesMundiais.ascx.cs" Inherits="Modulos_CMS_Modulos_ModIndicesMundiais_IndicesMundiais" %>
                ...
                <thead>
                    <tr>
                        <th class="colLft" colspan="4">
                            <asp:Literal ID="ltrCotacoes" runat="server" Text='<%# Resources.Cotacoes.IndicesMundiais %>'></asp:Literal><br />
                            <br />
                            <asp:Label ID="lblDataAtualizacao" runat="server" Text=""></asp:Label><span><%# Resources.Cotacoes.TempoAtualizacao %></span>
                        </th>
                    </tr>
                </thead>
                <tbody>
