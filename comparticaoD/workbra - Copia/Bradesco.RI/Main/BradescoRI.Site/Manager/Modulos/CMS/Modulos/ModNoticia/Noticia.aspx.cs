...
public partial class Modulos_CMS_Modulos_ModNoticia_Noticia : System.Web.UI.Page
{
    ...
    protected void ddlNoticia_SelectedIndexChanged(object sender, EventArgs e)
    {
    ...
    protected void grvNoticias_RowCommand(object sender, GridViewCommandEventArgs e)
    {
    ...
    protected void ddlTipoModuloNoticia_SelectedIndexChanged(object sender, EventArgs e)
    {
        try
        {
            ...
            {
                case 1:
                    CarregaCapaEsquerdo(ddlE1);
                    CarregaCapaDireitoSuperior(ddlD1);
                    CarregaCapaDireitaCentral();
                    CarregaCapaDireitaInferior(ddlD3);
                ...
                case 3:
                    CarregaCapaEsquerdo(ddlE1Destaque);
                    CarregaCapaDireitoSuperior(ddlD1Destaque);
                    CarregaCapaDireitaInferior(ddlD2Destaque);
    ...
    private void CarregaCapaDireitaInferior(DropDownList pDDL)
    {
    ...
    private void CarregaCapaEsquerdo(DropDownList pDDL)
    {
        Noticia noticia = null;
        try
        {
            ...
            case Utilitarios.TipoTransacao.Salvar:
                switch (ddlTipoModuloNoticia.SelectedValue)
                {
                    ...
                    case "2":
                        ...
                        {
                            ModNoticia objModNoticia = new ModNoticia() { TipoNoticiaId = Convert.ToInt32(ddlTipoNoticia.SelectedValue) };
