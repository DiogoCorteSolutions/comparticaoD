...
<div id="divConteudo" runat="server">
    <div class="row form-alerta-ri">
        ...
        <div runat="server" class="col-lg-12 col-lg-offset-0 col-md-12 col-md-offset-0 campo-form">
            <asp:TextBox ID="txtEstado" runat="server" MaxLength="128" TabIndex="5" placeholder="Digite os estado aonde mora"></asp:TextBox>
        </div>
       ...
       <div class="col-lg-12 col-lg-offset-0 col-md-12 col-md-offset-0 label-form">
        ...
        <div runat="server" class="col-lg-12 col-lg-offset-0 col-md-12 col-md-offset-0 campo-form">
            <asp:TextBox ID="txtEmpresa" runat="server" TabIndex="10" MaxLength="128" placeholder="Digite a empresa da qual você faz parte"></asp:TextBox>
        </div>
        ...
        <asp:Button ID="btnEnviar" runat="server" OnClick="btnEnviar_Click" TabIndex="12" ValidationGroup="ModAlertaRI" />
             </div>
        </div>
