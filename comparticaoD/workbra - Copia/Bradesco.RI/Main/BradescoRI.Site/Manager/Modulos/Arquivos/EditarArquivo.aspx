...
<asp:Content ID="Content1" ContentPlaceHolderID="contentInterna" runat="Server">
    ...
    <div>
        <label>
            ...
            <asp:DropDownList runat="server" ID="ddlTipoArquivo" title="Selecione o tipo de Arquivo"></asp:DropDownList>
    ...
    <div>
        <label>
            <span>
                <asp:Label ID="lblDataArquivo" runat="server" AssociatedControlID="txtDescricaoArquivo" title="Idioma"><%=Resources.Arquivos.LabelDescricao %>*</asp:Label>
            </span>
