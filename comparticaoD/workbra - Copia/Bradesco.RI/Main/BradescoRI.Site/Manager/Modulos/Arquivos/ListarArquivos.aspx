<%@ Page Title="" Language="C#" MasterPageFile="~/Modulos/Modulos.master" AutoEventWireup="true" CodeFile="ListarArquivos.aspx.cs" Inherits="Modulos_Arquivos_ListarArquivos" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="contentInterna" runat="Server">
    ...
    <div class="filtros">
        ...
        <div class="fields-edit">
            <label>
                ...
                <asp:DropDownList ID="ddlTipoArquivo" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddlTipoArquivo_SelectedIndexChanged" alt="Selecione o tipo de arquivo" title="Selecion o tipo de arquivo"></asp:DropDownList>
            </label>
    ...
    <asp:GridView summary="Lista de Arquivos" ID="grdDados" runat="server" AutoGenerateColumns="false" CssClass="listagem-Grid" AlternatingRowStyle-CssClass="par" Width="100%" AllowPaging="True"
        ...
        <Columns>
            ...
            <asp:BoundField DataField="TipoArquivoId" ItemStyle-Width="0%" HeaderStyle-Width="0%" />
            <asp:TemplateField  SortExpression="TipoArquivoId" HeaderStyle-CssClass="tabelaHeader asc" HeaderText="Tipo de Arquivo" ItemStyle-Width="40%" ItemStyle-HorizontalAlign="Left">
                <ItemTemplate >
                    <asp:Label ID="lblTipoArquivoId" runat="server"></asp:Label>
                </ItemTemplate>
            </asp:TemplateField>
            <asp:BoundField DataField="Titulo" SortExpression="Titulo" HeaderText="Título" ItemStyle-Width="50%" HeaderStyle-CssClass="tabelaHeader asc" />
            <asp:TemplateField HeaderText="Ações" HeaderStyle-CssClass="tabelaHeader" ItemStyle-Width="5%" ItemStyle-HorizontalAlign="Center">
                <ItemTemplate>
                    <a id="A1" title="Arquivo" runat="server" href='<%# String.Format("EditarArquivo.aspx?Arquivo={0}", Eval("Id"))%>'>
